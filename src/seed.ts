...
const PACKAGES: readonly (readonly [string, string])[] = [
	[
		"@assemora/schema",
		"The primitives every layer reads. No dependencies, ever",
	],
	[
		"@assemora/core",
		"Command Bus, Query Bus, Schema Registry, events, context",
	],
	...
	[
		...
		"The AST executed. Drizzle lives here and nowhere else",
	],
	...
	[
		...
		"What an agent proposed, previewed and not yet applied",
	],
	[
		"@assemora/mcp",
		"Every command and query, as a tool, generated from the registry",
	],
	["@assemora/theme", "The theme as tokens, and the stylesheet they render to"],
	[
		"@assemora/notifications",
		"What an application announces, to whom, over which channel",
	],
	[
		"@assemora/queue-bullmq",
		"Jobs on Redis: the queue port of SPEC.md §82, implemented",
	],
	["@assemora/plugin", "A module an npm package ships, and what it added"],
	[
		"@assemora/cli",
		"The assemora executable: generators, migrations, introspection",
	],
...
const build = async (
	...
	const declaration = await add(
		app,
		page,
		"declaration",
		declarationProps(copy),
	);
...
export const seed = async (app: Application): Promise<void> => {
	...
	console.log(
		`seeded ${ADMIN} — its password is in .env, as ASSEMORA_SEED_PASSWORD`,
	);
};
